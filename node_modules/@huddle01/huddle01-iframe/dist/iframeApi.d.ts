...
export declare type HuddleClientMethodName = 'muteMic' | 'unmuteMic' | 'enableWebcam' | 'disableWebcam' | 'enableShare' | 'disableShare' | 'startRecording' | 'stopRecording' | 'sendReaction' | 'connectWallet' | 'disconnectWallet' | 'toggleRaiseHand';
